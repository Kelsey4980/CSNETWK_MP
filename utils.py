...
class DisplayManager:
    ...
    def print_help(self):
        ...
        print("  revoke <token>          - Revoke a message by token")
        print()
        print("Game Commands:")
        ...
        print("  view_revoked_tokens     - View all revoked token messages")
        print("  print_all_received      - View all messages received")
        print("  print_all_sent          - View all messages sent")
        ...
        print("  ignore_file <file_id>                         - Ignore file offer")
        ...
        print("  group_message <group_key> <content>                            - Send group message")
        print("  group_update <group_key> -add <members> -remove <members>      - Update group")
